...
Usage:
    python bbox_annotator.py path/to/image.png
...
class BBoxAnnotator:
            ...
            if self.drawing and self.start_point:
                ...
                if abs(final_box.x2 - final_box.x1) > 5 and abs(final_box.y2 - final_box.y1) > 5:
                    ...
                    if question:
                        ...
                        print(f"  Range: x:[{final_box.x1}, {final_box.x2}], y:[{final_box.y1}, {final_box.y2}]")
    ...
    def draw_all(self) -> None:
        ...
        for i, box in enumerate(self.boxes):
            cv2.rectangle(self.display_image, (box.x1, box.y1), (box.x2, box.y2), 
                         self.box_color, 3)
            ...
            cv2.putText(self.display_image, label, (label_x, label_y),
    ...
    def draw_info_panel(self) -> None:
        ...
        panel_height = 120
        panel = np.zeros((panel_height, self.display_image.shape[1], 3), 
                        dtype=np.uint8)
        ...
        for line in info_lines:
            cv2.putText(panel, line, (15, y_offset), font, 
