...
all_blueprints = {
    ...
    "unitree-go2-agentic-mcp-surveillance": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_mcp_surveillance:unitree_go2_agentic_mcp_surveillance",
...
all_modules = {
    ...
    "light-skill": "dimos.agents.skills.light_skill",
